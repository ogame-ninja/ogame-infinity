 ...
 */
export function getAlliances(protocol, host, universe, universeNum, universeLang) {
  // TODO: need validation by expiration timestamp
  //

  const alliancePromise = requestOGameAlliances(protocol, host, universe, universeNum, universeLang).then(toAllianceResponseMap);
