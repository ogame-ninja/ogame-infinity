 ...
 */
export function getPlayers(protocol, host, universe, universeNum, universeLang) {
  // TODO: need validation by expiration timestamp
  //
  const responsePromise = requestOGamePlayers(protocol, host, universe, universeNum, universeLang).then(toPlayerResponse);
