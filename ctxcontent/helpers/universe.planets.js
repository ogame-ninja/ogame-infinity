 ...
 */
export function getPlanets(protocol, host, universe, universeNum, universeLang) {
  const planetResponse = requestOGamePlanets(protocol, host, universe, universeNum, universeLang).then(toPlanetResponse);
