...
this.universeLang=/s(\d+)-(\w+)/.exec(universe)[2];
  ...
  async update() {
    ...
    try {
      const [playersScore, playersInformation, playerPlanets, allianceInformation] = await Promise.all([
        getPlayersHighscore(this.protocol, this.host, this.universe, this.universeNum, this.universeLang),
        getPlayers(this.protocol, this.host, this.universe, this.universeNum, this.universeLang),
        getPlanets(this.protocol, this.host, this.universe, this.universeNum, this.universeLang),
        getAlliances(this.protocol, this.host, this.universe, this.universeNum, this.universeLang),
      ]);
