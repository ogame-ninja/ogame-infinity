...
function processData() {
  if (dataHelper) {
    ...
    universes[UNIVERSE] = new DataHelper(PROTOCOL, HOST, UNIVERSE);
  }
...
document.addEventListener("ogi-notification", function (e) {
  ...
  chrome.runtime.sendMessage({ type: "notification", protocol:window.location.protocol,host:window.location.host,universe: UNIVERSE, message: msg }, function (response) {});
});
